    ...
    <ul>
      ...
      <div key={channel.id} className="ChannelListItem w-full mb-1">
        <div className="indexContext bg-offWhite w-full h-[40px] flex flex-wrap">
          ...
          <span className="channelName leading-[40px] w-7/12 text-center">{channel.name}</span>
          <div className="ColDiv flex flex-col justify-center">
            {/* settings button */}
            <span className="w-2/12 text-center ">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-label">
                <path
                  fill-rule="evenodd"
