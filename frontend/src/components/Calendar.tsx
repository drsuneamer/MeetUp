...
import { removeSchedule, schedules } from '../stores/schedule';
...
export default function Calendar({
  ...
  const scheduleHandle = (cursor: { top: number; left: number }, scheduleData: { date: string; index: number }) => {
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="flex flex-1">
            ...
            <div className="flex flex-1 pt-2">
              {days.map((day) => (
                <div className="flex-1 min-w-[81px] flex flex-col relative" key={`scheduleline${day.day}`}>
                      ...
                      {scheduleData[day.day].map((s, idx) => {
                        ...
                        return (
                          <div
                            ...
                            onClick={(e) => {
                              scheduleHandle({ top: e.clientY, left: e.clientX }, { date: day.day, index: idx });
                            }}
                          >
                            {s.title}
                          </div>
