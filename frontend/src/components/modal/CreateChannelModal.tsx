...
function CreateChannelModal({
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
        ...
        <div>
          ...
          <div className="mt-[25px]">
            <div className="text-title font-bold text-[20px]">팀<span className="text-cancel">&#42;</span></div>
            <Autocomplete
              className="w-[450px]"
              ...
              // })}
              renderInput={(params) => (
                <TextField {...params} label="팀 선택하기" variant="standard" />
              )}
            />
          </div>
          <div className="mt-[25px]">
          ...
          <button className="font-bold bg-title hover:bg-hover text-background mt-[50px] rounded w-[450px] h-s drop-shadow-button">팀 채널 생성하기</button>
        </div>
        </div>
      <div
