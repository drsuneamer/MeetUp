...
function WebexModal({ onClickToggleModal }: PropsWithChildren<ModalDefaultType>) {
  return (
    <div className="w-[100%] h-[100%] fixed flex justify-center items-center">
      <div className="w-[450px] h-[300px] flex flex-col items-center bg-background z-10 rounded drop-shadow-shadow">
        ...
        <div className="flex flex-col justify-center items-center mt-[60px]">
          ...
          <button className="text-[16px] bg-title text-background hover:bg-hover mt-[40px] rounded w-[350px] h-s drop-shadow-button">
            이태희(컨설턴트)님의 웹엑스로 이동하기
          </button>
        </div>
      </div>
      <div
