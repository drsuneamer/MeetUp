...
export function MultipleLevelSelectionComponent<TItem = string>({
  ...
  return (
    <div>
      <div
        onClick={toggle}
        className={'relative flex bg-title rounded items-center justify-center drop-shadow-shadow text-s font-medium w-full h-s my-2 cursor-pointer'}
      >
        ...
        {/* 화살표 */}
        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="absolute right-0 mr-3 w-6 h-6">
          <path
            fillRule="evenodd"
