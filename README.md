...
| ![psm](README.assets/psm.png)                | ![kms](README.assets/kms.png)              | ![ysy](README.assets/ysy.png)                    |
| -------------------------------------------- | ------------------------------------------ | ------------------------------------------------ |
| BE [박성민👑](https://github.com/seongminP98) | BE [김명석](https://github.com/audtjr9514) | BE  [연승용](https://github.com/silversalmon216) |
| ![ssy](README.assets/ssy.png)                | ![lgm](README.assets/lgm.png)              | ![cmj](README.assets/cmj.png)                    |
...
<img src="https://img.shields.io/badge/visual studio code IDE-007ACC?style=for-the-badge&logo=visualstudiocode&logoColor=white"> <img src="https://img.shields.io/badge/react 18.2.0-61DAFB?style=for-the-badge&logo=react&logoColor=white"><img src="https://img.shields.io/badge/reduxtoolkit 1.8.5-764ABC?style=for-the-badge&logo=redux&logoColor=white"> <img src="https://img.shields.io/badge/typescript-3178C6?style=for-the-badge&logo=typescript&logoColor=white"> <img src="https://img.shields.io/badge/material ui-007FFF?style=for-the-badge&logo=mui&logoColor=white"> <img src="https://img.shields.io/badge/tailwind css-06B6D4?style=for-the-badge&logo=tailwindcss&logoColor=white">



### **API**

<img src="https://img.shields.io/badge/mattermost API-0058CC?style=for-the-badge&logo=mattermost&logoColor=white">  
...
| 버전     | 업데이트 내용                                                | 업데이트 날짜 |
| -------- | ------------------------------------------------------------ | ------------- |
| `v2.0.4` | **bugfix** 미팅 신청시 시작시간과 끝 시간 관련 오류 수정           | 22. 11. 23     |
| `v2.0.3` | **bugfix** UI 관련 업데이트 & 인스타그램 추가           | 22. 11. 21     |
| `v2.0.2` | **bugfix** 동시성 이슈 수정 & MM 알림에 요일 표시 추가           | 22. 11. 17     |
| `v2.0.1` | **feat** UI/UX +버튼 직관적으로 수정           | 22. 11. 16     |
| `v2.0.0` | **RELEASE** 2차 릴리즈 - 채널 생성, 그룹 기능 추가           | 22. 11. 15     |
| `v1.1.3` | **feat** 미팅 수정/삭제 mm 알림 추가  **changed** 이전 날짜에는 미팅 신청 불가 | 22. 11. 10     |
| `v1.1.2` | **feat** 미팅 중복 신청 불가 **bugfix** 밋업 삭제 후 재생성 가능 | 22. 11. 09     |
| `v1.1.1` | **feat** 팀 활성화/비활성화 기능 추가  **bugfix** 밋업 색 설정 UI 변경 | 22. 11. 09     |
| `v1.1.0` | **feat** 일정 공개/비공개 기능 추가  **design** 짧은 일정 출력 형식 변경 | 22. 11. 07     |
| `v1.0.9` | **feat** 컨설턴트 권한 로그인 시 바로 등급 부여              | 22. 11. 05     |
| `v1.0.8` | **bugfix** mm 알림 내용 표시 오류 수정                       | 22. 11. 04     |
| `v1.0.7` | **feat** 캘린더에서 나의 일정 확인 기능 추가                 | 22. 11. 04     |
| `v1.0.6` | **design** 로그인 페이지 UI 수정 (로딩 페이지 추가)          | 22. 11. 03     |
| `v1.0.5` | **feat** mm 비밀번호, 닉네임 변경 연동                       | 22. 11. 03     |
| `v1.0.4` | **feat** 밋업 수정/삭제 기능 추가 **design** 깃북 다이렉트 링크 추가 | 22. 11. 03     |
| `v1.0.3` | **bugfix** 컨설턴트/코치 로그인 오류 수정                    | 22. 11. 02     |
| `v1.0.2` | **bugfix** 로그인, 비밀번호 오류 alert 수정                  | 22. 11. 02     |
...
![addmeeting](README.assets/addmeeting.gif)
...
![editdeletemeeting](README.assets/editdeletemeeting.gif)

- 그룹과 알림 채널을 제외한 디테일은 수정 가능하며, 수정/삭제 알림도 mm으로 전송

#### 3. 개인 스케줄 설정

![addschedule](README.assets/addschedule.gif)

- 다른 사람이 나의 일정이 있는 시간에 미팅을 신청할 수 없도록, 개인 스케줄 추가 가능
- 공개 여부를 `비공개`로 설정하면 다른 사람에게는 스케줄의 제목이 보이지 않음

![editdeleteschedule](README.assets/editdeleteschedule.gif)
...
![image-20221117145035828](README.assets/image-20221117145035828.png)



##### 6-2. 미팅/그룹/채널 생성시 필수 입력값 비어있는 경우 alert

![image-20221117145548080](README.assets/image-20221117145548080.png)
